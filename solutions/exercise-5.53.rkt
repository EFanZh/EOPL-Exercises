...
;; spawn expression. Instrument the interpreter to trace the creation of thread identifiers. Check to see that the ready
;; queue contains at most one thread for each thread identifier. How can a child thread know its parent’s identifier?
;; What should be done about the thread identifier of the original program?
