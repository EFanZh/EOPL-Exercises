...
(define apply-cont
  (lambda (cont val)
    (cases continuation cont
      ...
      [raise1-cont (saved-cont resume-cont) (apply-handler val saved-cont resume-cont)])))
...
(define value-of/k
  (lambda (exp env cont try-cont1)
    (cases expression exp
      ...
      [raise-exp (exp1) (value-of/k exp1 env (raise1-cont try-cont1 cont) try-cont1)])))
